...
export const onHold = asyncHandler(async (req, res) => {
    ...
    if (req.activeRole === "screener") {
        ...
        status = await LeadStatus.findByIdAndUpdate(
            { _id: lead.leadStatus },
            { isHold: true, stage: "APPLICATION", subStage: "LEAD ON HOLD" },
            { new: true }
        );
        ...
        status = await LeadStatus.findByIdAndUpdate(
            ...
            { isHold: true, stage: "APPLICATION",subStage:"APPLICATION ON HOLD" },
            { new: true }
        );
        ...
        status = await LeadStatus.findByIdAndUpdate(
            ...
            { isHold: true, stage: "SANCTION" , subStage: "SANCTION ON HOLD" },
            { new: true }
        );
        ...
        status = await LeadStatus.findByIdAndUpdate(
            ...
            { isHold: true, stage: "DISBURSAL" , subStage : "DISBURSAL APPLICATION ON HOLD" },
            { new: true }
        );
...
export const unHold = asyncHandler(async (req, res) => {
    ...
    if (req.activeRole === "screener") {
        ...
        status = await LeadStatus.findByIdAndUpdate(
            { _id: lead.leadStatus },
            { isHold: false, stage: "APPLICATION" , subStage:"LEAD UNHOLD" },
            { new: true }
        );
        ...
        status = await LeadStatus.findByIdAndUpdate(
            { _id: sanction.application.lead.leadStatus },
            { isHold: false, stage: "SANCTION" , subStage:"SANCTION UNHOLD" },
            { new: true }
        );
        ...
        status = await LeadStatus.findByIdAndUpdate(
            { _id: disbursal.sanction.application.lead.leadStatus },
            { isHold: false, stage: "DISBURSAL" , subStage:"DISBURSAL UNHOLD" },
            { new: true }
        );
